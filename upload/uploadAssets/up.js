...
jQuery(function() {
    ...
    WebUploader.Uploader.register({
        ...
        beforeSendFile: function(file) {
			file.name = finalFilename===null?file.name:finalFilename;
    ...
    uploader.on('fileQueued', function(file) {
        ...
        html += "            <div class=\"progressName\"><a style=\"font-size:20px;color:white;background:red;padding:0 1px;margin-top:-5px;border-radius: 20px;\" href=\"javascript:upload_cancle('" + file.id + "');\" class=\"pure-button\">×</a></div>";
        html += "            <div class='jindu'><div class=\"progressBarInProgress\" style=\"width: 0.01%;\"></div></div>";
        html += "            <div class=\"progressBarStatus\" style=\"margin-top: -10px;font-size: 13px;\"><ul>";
    ...
    $('#startUpload').click(function(){
		if(uploader.getFiles().length===0){
			var i = layer.alert('清先添加视频！',{icon:2},function(){
				layer.close(i);
